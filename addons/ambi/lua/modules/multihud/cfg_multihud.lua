...
Ambi.MultiHUD.Config.command = 'mystic' -- Консольная команда "ambi_hud_КОМАНДА" для смены худа, для каждого сервера должна быть уникальной, Например: ambi_hud_default, ambi_hud_rus
