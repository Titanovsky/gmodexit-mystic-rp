...
function ENT:Draw()
    ...
    cam.Start3D2D( pos + ang:Up() * 3.35, ang, 0.07 )
        draw.SimpleTextOutlined( 'Жидкая', UI.SafeFont( '24 Ambi' ), 0, -38, C.ABS_WHITE, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, C.ABS_BLACK )
        draw.SimpleTextOutlined( 'Сера', UI.SafeFont( '24 Ambi' ), 0, -20, C.ABS_WHITE, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, C.ABS_BLACK )
