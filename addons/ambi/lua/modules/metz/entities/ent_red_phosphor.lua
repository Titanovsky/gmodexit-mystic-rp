...
if SERVER then
    function ENT:Initialize()
        Ents.Initialize( self, Ambi.Metz.Config.ingredient_red_phosphor_model )
        Ents.Physics( self, MOVETYPE_VPHYSICS, SOLID_VPHYSICS, nil, true, true )

        self:SetMaterial( Ambi.Metz.Config.ingredient_red_phosphor_material )
        self:SetColor( Ambi.Metz.Config.ingredient_red_phosphor_color )
        self:SetAmount( 1 )
    end
