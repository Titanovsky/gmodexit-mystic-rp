Ambi.General.CreateModule( 'DarkRP' ) -- Ambi
-- Mystic RP
...
Ambi.DarkRP.Config.restrict_spawn_entities = 1 -- Запреты на спавн Энтити
Ambi.DarkRP.Config.restrict_spawn_weapons = 1 -- Запреты на спавн/выдачу Оружия
Ambi.DarkRP.Config.restrict_spawn_npcs = 1 -- Запреты на спавн NPC
Ambi.DarkRP.Config.restrict_spawn_vehicles = 1 -- Запреты на спавн Транспортных Средств
...
Ambi.DarkRP.Config.player_payday_delay = 60 * 20 -- Задержка в секундах по выдаче зарплаты 
...
--* ====================================================================================================================================================== --
Ambi.DarkRP.Config.hunger_enable = false -- Включить/Выключить систему Голода? ( Методы Player:SetSatiety() и Player:SetMaxSatiety() )
...
Ambi.DarkRP.Config.jobs_create_defaults = false -- Создать стандартные работы: Гражданин, Полицейский и т.д --![НУЖЕН РЕСТАРТ]
...
Ambi.DarkRP.Config.shop_create_defaults = false -- Создать стандартные предметы
...
Ambi.DarkRP.Config.money_drop_entity_model = 'models/john/euromoney.mdl' -- Валюта дропнется с какой моделькой? Работает только с энтити spawned_money
...
Ambi.DarkRP.Config.buy_auto_ammo_count = 30 -- Типичное количество патронов за одну покупку

--* ====================================================================================================================================================== --
Ambi.DarkRP.Config.f4menu_enable = false -- Включить стандартное F4 Меню
...
Ambi.DarkRP.Config.police_system_wanted_time = 500 -- Сколько игрок будет в розыске (если 0, то всегда)
...
Ambi.DarkRP.Config.goverment_laws_default = { -- Всего можно 9 законов
    ...
    [ 4 ] = 'Запрещено содержать Светлых Мистиков',
    [ 5 ] = '',
    [ 6 ] = '',
    [ 7 ] = '',
    [ 8 ] = '',
