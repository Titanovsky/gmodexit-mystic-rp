...
-- SWEP Construction Kit was used for the world model only.

SWEP.WElements = {
	["glass_bottle_world"] = { type = "Model", model = "models/props_junk/garbage_glassbottle003a.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, -85), size = Vector(1, 1, 1), color = Color(189, 69, 24, 255), surpresslightning = false, material = "models/debug/debugwhite", skin = 0, bodygroup = {} }
}
...
-- SWEP Construction Kit code ends here!
