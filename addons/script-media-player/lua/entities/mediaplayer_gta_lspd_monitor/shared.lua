...
ENT.Category 		= "Media Player - GTA V Pack"
...
ENT.Model = Model( "models/mark2580/gtav/electrical/pc_monitor_lspd_mugshot.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-75.7, 90, 0),
	offset = Vector(-1.25, 10.5, 20.6), -- Right/Left | Forward/Back | Up/Down 
	width = 21,
	height = 15
} )
