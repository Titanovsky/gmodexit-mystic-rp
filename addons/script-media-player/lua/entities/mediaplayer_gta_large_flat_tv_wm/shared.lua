...
ENT.Model = Model( "models/mark2580/gtav/mp_apa_mid/hall/prop_tv_flat_01_high.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-90, 90, 0),
	offset = Vector(3.32, 42.8, 26.65), -- Forward/Back | Left/Right | Up/Down 
	width = 86,
	height = 48
} )
