...
ENT.PrintName 		= "Small Flat Monitor"
ENT.Author 			= "MARK2580"
...
ENT.Model = Model( "models/mark2580/gtav/electrical/tv_flat_03b.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-90, 90, 0),
	offset = Vector(2.665, 14, 8.9), -- Right/Left | Forward/Back | Up/Down 
	width = 28,
	height = 16
} )
