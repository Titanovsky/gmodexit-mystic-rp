...
ENT.Model = Model( "models/mark2580/gtav/electrical/big_stand_tv_mid.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-90, 90, 0),
	offset = Vector(1.85, 30, 41.2), -- Right/Left | Forward/Back | Up/Down 
	width = 60,
	height = 34
} )
