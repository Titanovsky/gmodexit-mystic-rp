...
ENT.Model = Model( "models/mark2580/gtav/mp_apa_06/lobby/v_res_mm_audio.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-84.7, 90, 0),
	offset = Vector(6, 1.52, 5.67), -- Forward/Back | Left/Right | Up/Down 
	width = 3,
	height = 4
} )
