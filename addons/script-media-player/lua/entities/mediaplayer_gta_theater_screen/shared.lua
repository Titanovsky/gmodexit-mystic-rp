...
ENT.Model = Model( "models/mark2580/gtav/electrical/prop_tv_flat_01.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-90, 90, 0),
	offset = Vector(4, 51.5, 32.1), -- Forward/Back | Left/Right | Up/Down 
	width = 103,
	height = 58
} )
