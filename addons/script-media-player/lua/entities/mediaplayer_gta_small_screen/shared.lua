...
ENT.Model = Model( "models/mark2580/gtav/electrical/club_roc_mscreen.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-90, 90, 0),
	offset = Vector(1.3, 15.55, 9.71), -- Forward/Back | Left/Right | Up/Down 
	width = 31.2,
	height = 19
} )
