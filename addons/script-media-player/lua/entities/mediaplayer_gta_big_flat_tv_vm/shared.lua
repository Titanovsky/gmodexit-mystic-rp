...
ENT.Model = Model( "models/mark2580/gtav/yacht_map/electrical/prop_tv_flat_01.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-90, 90, 0),
	offset = Vector(2.35, 30.5, 19), -- Forward/Back | Left/Right | Up/Down 
	width = 61,
	height = 34
} )
