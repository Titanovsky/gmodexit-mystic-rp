...
ENT.Model = Model( "models/mark2580/gtav/yacht_map/electrical/prop_tv_flat_02.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(0, 0, 90),
	offset = Vector(-22.5, 1.75, 14.3), -- Right/Left | Forward/Back | Up/Down 
	width = 45,
	height = 25
} )
