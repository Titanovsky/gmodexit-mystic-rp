...
ENT.Model = Model( "models/mark2580/gtav/mp_apa_low/bedroom/tv_flat_03.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-90, 90, 0),
	offset = Vector(0.26, 13.5, 16.492), -- Forward/Back | Left/Right | Up/Down 
	width = 27,
	height = 15.1
} )
