...
ENT.PrintName 		= "Michael's TV (Medium)"
ENT.Author 			= "MARK2580"
...
ENT.Model = Model( "models/mark2580/gtav/electrical/tv_flat_michael.mdl" )

list.Set( "MediaPlayerModelConfigs", ENT.Model, {
	angle = Angle(-90, 90, 0),
	offset = Vector(2.35, 29.4, 18.4), -- Right/Left | Forward/Back | Up/Down 
	width = 59,
	height = 32.05
} )
