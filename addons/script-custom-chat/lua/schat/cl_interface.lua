...
function SChat:ApplyTheme(invalidate)
	...
	self.entryDock:SetBackgroundColor(Theme.input_background)
...
chat.Open = function()
	...
	if SChat.teamMode == true then
		...
		SChat.entryDock:SetBackgroundColor(teamColor)
	else
		SChat.entry:SetPlaceholderText('Say...')
		SChat.entryDock:SetBackgroundColor(Theme.input_background)
	end
