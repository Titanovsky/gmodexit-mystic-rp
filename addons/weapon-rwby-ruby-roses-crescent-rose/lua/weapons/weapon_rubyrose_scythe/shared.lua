//ALL Credit goes to Big Black for making this base, it's very simple and very easy to use!
//...since you can read this, I'm assuming you've extracted the .gma
//in that case, have fun with it. You'll see comments from time to time describing features.
//Look for comments!
//And have fun with RUBY ROSE'S SCYTHE!
...
function SWEP:PrimaryAttack()
	...
	if ( trace.Hit ) then
		...
		self.Weapon:EmitSound(self.MissSound,100,math.random(90,120))	//Play a miss sound.
		self.Weapon:SendWeaponAnim( ACT_VM_IDLE )
